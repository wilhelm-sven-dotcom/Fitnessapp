...
/** Route-level safety net: any render error in /briefing degrades to a friendly
 *  in-app message (with retry) instead of the full-page Next.js error screen. */
export default function BriefingError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
