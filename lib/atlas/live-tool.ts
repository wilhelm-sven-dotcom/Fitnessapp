...
export const LIVE_RULES = [
  ...
  "Eingriff nur mit klarer Begründung: RIR 0 und Ziel verfehlt → eher Gewicht senken; viel Luft (RIR ≥ 3) und Rekordnähe → gezielt anheben; Zeitnot laut Transkript → keine Pausenverlängerung. Sicherheit vor Ego.",
